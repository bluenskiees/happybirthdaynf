            ...
            <div className="w-full px-8 pb-20 md:pb-0 md:pl-16 lg:pl-24 md:max-w-2xl">
              ...
              >
                ...
                >
                  ...
                  <p className="text-xs tracking-[0.4em] text-cream-light/60 font-light">EIGHTEENTH</p>
                  <p className="text-xs tracking-[0.4em] text-cream-light/60 font-light">2007</p>
                </motion.div>
              </motion.div>
